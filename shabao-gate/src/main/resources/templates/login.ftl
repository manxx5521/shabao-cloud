...
<link href="${ctx}/resources/bootstrap/css/font-awesome.min.css" rel="stylesheet">
<link href="${ctx}/resources/bootstrap/css/animate.min.css" rel="stylesheet">
<script>
...
<body class="signin">
	...
	<script src="${ctx}/resources/jquery/jquery-1.12.4.min.js"></script>
